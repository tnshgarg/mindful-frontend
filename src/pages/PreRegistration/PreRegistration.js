...
var PreRegistration = function () {
    return (React.createElement("div", { style: {
        ...
        React.createElement("img", { src: require("../../assets/logo.svg").default, style: {
                display: "block",
                marginLeft: "auto",
                marginRight: "auto",
            }, width: 70, height: 70 }),
        ...
        React.createElement("div", { style: { marginTop: 40 } },
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("img", { width: 20, height: 20, src: require("../../assets/greenCheck.svg").default }),
        ...
        React.createElement("div", { style: { marginTop: 40 } },
            React.createElement("h3", { style: {
                ...
                "Mindful Care",
                " ",
                React.createElement("span", { style: { textDecorationLine: "underline" } }, "does not provide"),
                " ",
                "the following:"),
            React.createElement("div", { style: {
                    marginLeft: 60,
                ...
                React.createElement("img", { width: 20, height: 20, src: require("../../assets/redCross.svg").default }),
                React.createElement("h4", { style: {
                        fontWeight: 600,
                        fontFamily: "Montserrat",
                        marginLeft: 10,
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("h4", { style: {
                    ...
                    " ",
                    React.createElement("a", { href: "https://google.com", style: { color: "blue", textDecorationLine: "underline" } }, "medication policy"),
                    " ",
        ...
        React.createElement(Button, { variant: "box", title: "Continue to sign-up", navUrl: "/registration", wide: true })));
};
